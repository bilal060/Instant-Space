          ...
          <div className="bookings-head flex flex-xl-row flex-column pt-10 pb-4 md:justify-between justify-start">
            ...
            Payment History
                      ...
                      <div className='flex flex-xl-row flex-column'>
                          ...
                          <button className='font-bold text-base mt-1 text-white bg-[#0064FA] custom-button-width !border !border-solid border-[#0064FA] rounded-xl flex justify-center items-center' data-bs-toggle="modal" data-bs-target="#exampleModal"> <div className="text-3xl font-light mb-1 mr-1 leading-3">+</div> Add Payment Method</button>
                  ...
                  <div className="modal-dialog rounded-lg">
                      <div className="modal-content">
                          <div className="modal-header">
                              <h1 className="custom-modal-title fw-bolder ml-6" id="exampleModalLabel">Add Payment Method</h1>
