        ...
        <div>
            <div className="content-head flex flex-sm-row flex-col justify-between items-center pl-2 pr-4 mb-5">
                <div className="title text-lg pb-sm-0 pb-4 font-[500] text-gray">
                    My Spaces / <span className='text-primary font-[600]'>ACE Parking Lounge</span>
                </div>
                <div className="flex">
                        ...
                        <div className='col-xxl-6'>
                            <div className="text bg-white rounded-lg">
                                <div className='flex items-center justify-between w-100 mb-5'>
                                    <span className="fs-3hx fw-bold text-dark me-2 lh-1 ls-n2">ACE Parking Lounge </span>
                                ...
                                <div className="row m-0 pt-4">
                                    ...
                                    <div className="px-0 col-6 flex items-center">
                                        <img
                                            ...
                                            className="h-5 w-5"
                                        />
                                        <label className="fs-2 pl-5">Capacity: 300</label>
                                    </div>
                                </div>
                                <div className="row m-0 py-4 ">
                                    ...
                                    <div className="px-0 col-6 flex items-center">
                                        <img
                                            ...
                                            className="h-5 w-5"
                                        />
                                        <label className="fs-2 pl-5">Rate: $5</label>
                                    </div>
                                </div>
                                <div className="row m-0">
                                    <div className="px-0 col-12 flex items-center">
                                        <img
                                            ...
                                            className="h-5 w-5"
                                        />
                                        <label className="fs-2 pl-5">Belmont, North Carolina</label>
                                    </div>
                                </div>

                                <div className="flex items-center gap-5 mt-4">
                                    <span className='fs-2 font-semibold'>All Facilities:</span>
                                    <div className="px-1">
                                        <img
                                            alt=""
                                        ...
                                        return (
                                            <div className='flex items-center justify-between w-100 managerno' key={index}>
                                                <div className='flex gap-3'>
                                                    ...
                                                    <div>
                                                        <p className='mb-1 text-lg text-gray'>Full Name</p>
                                                        <p className='mb-0 text-xl font-bold text-grey-600'>{data.name}</p>
                                                    </div>
                                                </div>
                                                <div>
                                                    <p className='mb-1 text-lg text-gray'>Contact Info</p>
                                                    <p className='mb-0 text-xl font-bold text-grey-600'>{data.contactinfo}</p>
                                                </div>
                                                <div>
                                                    <p className='mb-1 text-lg text-gray'>Shift Time Slot</p>
                                                    <p className='mb-0 text-xl font-bold text-grey-600'>{data.shiftTime}</p>
                                                </div>
                                            </div>
                                        )
                                    })}
            ...
            <div className="card card-flush card-shadow  mb-5 mb-xl-10">
                <div className='card-header !items-center !py-[24px] !px-[32px]'>
                    <h3 className='fs-1 font-bold m-0 h-max	'>Customers Reviews </h3>
                </div>
                    ...
                    {reviews.map((data, index) => {
                        return (
                            <div key={index} className='flex gap-3 items-start reviews border-b pb-[32px] mb-[32px]'>
                                <img src={data.img} alt="" />
                                <div>
                                    <p className='mb-0 font-bold text-grey-600'>{data.name}</p>
                                    <div className='flex gap-1 items-center mb-7'>
                                        <p className='mb-0 text-gray'>{data.rating}</p>
