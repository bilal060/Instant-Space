...
export default function AddNewSpaceCard() {
  return (
    ...
    <div className="img flex-col justify-center items-center ">
      ...
      <Link to='/my-spaces' className='font-bold flex justify-center   text-base bg-[#0064FA1A] text-primary py-4 w-full !border !border-solid border-[#0064FA] rounded-xl mb-4'>View All Spaces</Link>
